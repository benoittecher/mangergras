        ...
        <header class="bg-dark text-white rounded-top perso_policeTitre perso_shadow">
            <div class="row align-items-center m-0">
                <div class="col-2 p-2 text-center">
                    <a href="">
                        <img src=""  class="rounded-circle img-fluid"  alt="logo du site">
                    </a>
                </div>

                <div class="col-8 m-0 p-0">
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark perso_colorMenu perso_size20">
                ...
                <div class="col-2 text-right pt-1 pr-4 d-none d-lg-block"> MANGERGRAS</div>
